...
<main role="main">
    ...
    <div class="container marketing">
        ...
        <div class="row">
            <?php
            foreach ($arrayOfArticles as $articleObject) {
...
//                echo "<img class='' src='../resources/images/$articleObject->image' alt='Generic placeholder image' width='100%'' height='140'>";
                ...
                echo "<p><a class='btn btn-secondary'" ?> href="<?php echo URLROOT; ?>/posts/show/<?php echo $articleObject->id; ?>" <?php echo " role='button'>View details &raquo;</a></php>";
                echo "</div>";
            }
            ?>
